    ...
    <template v-slot:content>
      <div class="columns">
        <div class="column">
          ...
          <p><strong>House work.</strong> That's right I actually enjoy knocking out honey do lists with some home improvements. So much that I did all the designing, planning and construction of our unfinished basement.</p>
